...
return (("File generated using [Zartha]") and (function()
	return (function(Env, Constants, shiftKey, decrypt) -- Vars
		local char, insert, byte, sub, match, freeze, ttostring, pcall, unpack, concat, tonumber, setmeta, __metatable, __tostring, __index, __call, proxy, pnt, __pairs, __ipairs, Constants, pairs, __newindex = Env["string"]["char"], Env["table"]["insert"], Env["string"]["byte"], Env["string"]["sub"], Env["string"]["match"], Env["table"]["freeze"], Env["tostring"], Env["pcall"], Env["table"]["unpack"], Env["table"]["concat"], Env["tonumber"], Env["setmetatable"], "__metatable", "__tostring", "__index", "__call", Env["newproxy"], Env["print"], "__pairs", "__ipairs", {
			(decrypt("\071\068\090\089\066", "763")),
			(decrypt("\090\092\089\091\093", "2957")),
			(decrypt("\001\061", "1601")),
			(decrypt("\066\068\090\089\070\080", "2637")),
			(decrypt("\110\110\092\095\085\084\077", "1151")),
			(decrypt("\095\081\070", "1411")),
			(decrypt("\069\085\069\065\110\067\083\089\087\111\089\069\082\095\082\080", "1065")),
			(decrypt("\089\085\092\094\094\016\094\093\094\082\067", "1002")),
			(decrypt("\006\063", "2437")),
			(decrypt("\000\059", "2019")),
			(decrypt("\003\006\050", "2099")),
			(decrypt("\089\093\024\088\072\020\086\084\092\081\024\092\066\020", "1485")),
			(decrypt("\017\088\094\085\025\089\069\025\089\066\025\087\067\092\081\069\025\068\094\025\093\084\092\068\017\064\095\068", "190")),
			(decrypt("\000\062", "1594")),
			(decrypt("\004\056", "1329")),
			(decrypt("\001\057", "2221")),
			(decrypt("\011\012\051", "2589")),
			(decrypt("\009\057", "1203")),
		}, Env["pairs"], "__newindex"
...
, (function()
		...
		-- Handle constant table
				setmeta(Constants, {
					...
					end, -- looping constants as string would crash the VM
					[__ipairs] = function()
						return function()
							pointer = pointer + 10
						end
	...
	-- VM STARTS HERE
			for i = 1, (1 + 10) ^ 100 do
				...
				elseif pointer == 14 then -- 28 [CALL]
					...
					Temp[4] = {
						Stack[Temp[1]](unpack(Temp[3], 1, Temp[5] - Temp[1]))
					}
				...
				elseif pointer == 16 then -- 36 [CLOSURE]
					...
					Stack[10] = function(...) -- PROTOTYPE 1
						local Constants = {
							(decrypt("\008\051", "887")),
							(decrypt("\065\083\090\075\066", "1239")),
							(decrypt("\000\002\050", "2195")),
							(decrypt("\007\061", "2613")),
							(decrypt("\001\000\050", "2690")),
							(decrypt("\006\005\003\056", "1163")),
							(decrypt("\001\050", "2994")),
							(decrypt("\003\059", "1007")),
							(decrypt("\004\006\051", "548")),
							(decrypt("\004\000\007\062", "1645")),
							(decrypt("\006\057", "1235")),
							(decrypt("\002\002\062", "745")),
							(decrypt("\010\062", "2562")),
							(decrypt("\005\003\061", "346")),
							(decrypt("\005\059", "402")),
						}
						local Varargs = {}
						local Stack = {}
 ...
 -- [PSEUDO] Handled by CLOSURE
				...
				elseif pointer == 22 then -- 36 [CLOSURE]
					...
					Stack[12] = function(...) -- PROTOTYPE 2
						local Constants = {
							(decrypt("\070\086\069\088\086\069\084\071\080\087\095\084", "531")),
							(decrypt("\065\000", "1127")),
						}
						local Varargs = {}
						local Stack = {}
						local Args = {
 ...
 -- [PSEUDO] Handled by CLOSURE
				...
				elseif pointer == 25 then -- 36 [CLOSURE]
					...
					Stack[12] = function(...) -- PROTOTYPE 3
						local Constants = {
							(decrypt("\073\067\094\087\069", "917")),
							(decrypt("\066\001", "2077")),
						}
						local Varargs = {}
						local Stack = {}
						local Args = {
		...
		-- Params
				...
				elseif pointer == 65 then -- 36 [CLOSURE]
					...
					Stack[21] = function(...) -- PROTOTYPE 4
						local Constants = {
							(decrypt("\000\011\051", "2980")),
							(decrypt("\006\001\060", "2572")),
							(decrypt("\002\004\059", "1308")),
						}
						local Varargs = {}
						local Stack = {}
						local Args = {
